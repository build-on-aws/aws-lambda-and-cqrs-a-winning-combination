...
![One of the ending points for the discussion: CQRS implementation (AFTER)](./docs/approach-01-commands-and-queries-dispatchers-components.png)

![One of the ending points for the discussion: CQRS implementation deployed on AWS Lambda (AFTER)](./docs/approach-01-commands-and-queries-dispatchers-deployment.png)
