...
import { DatabaseDetails, DatabaseProvider } from "./database/DatabaseProvider";
...
export const init = (async () => {
  ...
  const databaseDetails: DatabaseDetails = { tableName, entityTypeIndexName, entityStatusIndexName };
  const databaseProvider = new DatabaseProvider(databaseDetails, DI.logger);

  DI.repositoriesFactory = new RepositoriesFactory(databaseProvider);
